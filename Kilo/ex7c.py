...
# The parentheses are optional; the author believes they improve readability. In other words, x = (y > 3) is the same as x = y > 3.
...
# Python calls them 'bool', which is short for 'boolean'. As you'll find documented on thousands of websites, 
# a boolean value is simply a value that can only be True or False.
